...
| k8s.context                     | no       | kubernetes-admin@mgmt                                                     |                           | Kubernetes context to create gitea resources                                      |
| k8s.version                     | no       | v1.27.1.2                                                       |                           | Kubernetes version used for the management cluster                                |
